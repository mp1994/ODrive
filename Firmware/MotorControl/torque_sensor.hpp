...
class TorqueSensor : public ODriveIntf::EncoderIntf {       // Da capire cosa mettere qui al posto di ODriveIntf::EncoderIntf
public:
    ...
    TorqueSensor(TIM_HandleTypeDef* timer, Stm32Gpio index_gpio,
